...
//Movies data extracted from cloud 9

// Firebase
var Rebase = require('re-base')
var base = Rebase.createClass({
  apiKey: "AIzaSyCxn9zmhITRGSUMMs2dJjQMvff1LCfh2W8",   // replaced with my api ID
  databaseURL: "https://buyflix-final-3b94b.firebaseio.com", // replaced with my URL
})
      ...
      return (
        <div className="col-sm-12">
          <Gmaps width={'100%'}
                 ...
                 lng={'-87.6285782'}
                 zoom={10}
                 loadingMessage={'Theaters appearing soon...'}
                 params={{v: '.3exp', key: 'AIzaSyCn0xIRirSqAy6Rff4vwjZwKFYMayfa2Iw'}}>
